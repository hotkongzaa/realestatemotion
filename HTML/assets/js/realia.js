...
function LoadMapProperty() {
    var locations = new Array(
            [13.813595, 100.422799]
            );
    var markers = new Array();
    var mapOptions = {
        center: new google.maps.LatLng(13.813595, 100.422799),
        zoom: 17,
    ...
    $.each(locations, function (index, location) {
        ...
        var myOptions = {
            content: '<div class="infobox"><div class="image"><img src="assets/img/detail/1.jpg" alt="" width="70px"></div><div class="title"><a href="detail.html">???? ???? (?????-???????)</a></div><div class="area"><span class="key">?????????????:</span><span class="value">120m<sup>2</sup></span></div><div class="price">3,590,000 ???</div><div class="link"><a href="detail.html">View more</a></div></div>',
